...
public class ChatControllerTest
{
	...
	{
		assertNotNull("Data member not initialized", testController.getNickChatBot());
		assertNotNull("Data member not initialized", testController.getChatDisplay());
		assertTrue("Wrong display type", (testController.getChatDisplay() instanceof ChatView));
